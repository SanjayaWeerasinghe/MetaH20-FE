      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Next Generation
            <span className="gradient-text block">Solana Token ICO</span>
          </h1>
          
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join the future of decentralized finance. Secure your position in our revolutionary blockchain ecosystem powered by Solana's lightning-fast network.
          </p>
